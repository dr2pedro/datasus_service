// @filename: SINANManyCityCriteria.ts
...
export class NotificationSINANManyCitiesCriteria extends ArrayCriteria<Notification, 'ID_MUNICIP'> {
    static set(cityCode: string[]) {
        ...
        return new NotificationSINANManyCitiesCriteria('NotificationSINANManyCitiesCriteria', cityCode, 'ID_MUNICIP')
    }
}
